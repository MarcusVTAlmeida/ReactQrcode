...
import ProfileScreen from './ProfileScreen';  // A tela de perfil que você mencionou
        ...
        <div style={styles.inputContainer}>
          ...
          {qrCodeData && (
            <div style={styles.qrCodeContainer}>
              ...
              <QRCodeSVG value={qrCodeData.qrCodeValue} size={150} />
            </div>
          )}
        </div>

        {/* Botão de Navegação para a Tela de Perfil */}

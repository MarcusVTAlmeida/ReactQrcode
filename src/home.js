...
export default function App() {
  ...
  const [dynamicLink, setDynamicLink] = useState(''); // Variável para armazenar o link dinâmico
  ...
  const handleSaveQRCode = async () => {
    ...
    try {
      ...
      if (isStaticMode) {
        ...
        setDynamicLink(dynamicLink); // Armazenar o link dinâmico
      ...
      <div style={styles.inputContainer}>
        ...
        {qrCodeValue && (
          <div style={styles.qrCodeContainer} ref={qrCodeRef}>
            <QRCodeCanvas
              value={isStaticMode ? qrCodeValue : dynamicLink} // Usar dynamicLink para QR Code dinâmico
              size={150}
              fgColor={fgColor}
              bgColor={bgColor}
              imageSettings={
